...
PEMEAST_HA = {
    '1': 'Rasha Younes',
    '2': 'Sophia Dauria',
    '3': 'Kailina Mastroianni'
}


PEMEAST_PM = [
    'Margaret Sumner-Moore',
    'Rasha Younes'
]
...
ROCK_C3 = [
    #Put second floor customs people because there were no third floor
    'Gabrielle Smith',
    'Angela Motte',
    'Miriam Ahmed'
]
...
EMAILS = {
    ...
    'Angela Motte': 'amotte@brynmawr.edu',
    'Anna Sargeant': 'asargeant@brynmawr.edu',
    'Angela Mastrianni': 'amastriann@brynmawr.edu',
    ...
    'Caitlyn Hasenfratz': 'chasenfrat@brynmawr.edu',
    'Catherine Woodrow': 'cwoodrow@brynmawr.edu',
    'Callie Lopshire-Bratt': 'clopshireb@brynmawr.edu',
    'Carol Bowe': 'cbowe@brynmawr.edu',
    'Caroline Randive': 'crandive@brynmawr.edu',
    'Celeste Ledesma': 'cledesma@brynmawr.edu',
    'Chanel Williams': 'cwilliam02@brynmawr.edu',
    'Christina Ulowetz': 'culowetz@brynmawr.edu',
    'Chutong Zhu': 'czhu@brynmawr.edu',
    'Claire Craig': 'cacraig@brynmawr.edu',
    'Dionne Agawu': 'sdagawu@brynmawr.edu',
    ...
    'Faith Daniel': 'fdaniel@brynmawr.edu',
    'Fiona Gambanga': 'fgambanga@brynmawr.edu',
    'Gabrielle Smith': 'gbsmith@brynmawr.edu',
    ...
    'Maira Karan': 'mkaran@brynmawr.edu',
    'Makeda Warde': 'mwarde@brynmawr.edu',
    'Marcia Manzone': 'mmanzone@brynmawr.edu',
    'Margaret Sumner-Moore': 'msumnermoo@brynmawr.edu',
    'Maria McGurrin': 'mmcgurrin@brynmawr.edu',
    'Maritza Vazquez-Trejo': 'mvazqueztr@brynmawr.edu',
    'Maya Berrol-Young': 'mberrolyou@brynmawr.edu',
    'Meera Jayaraman': 'mjayaraman@brynmawr.edu',
    'Meredith Scheiring': 'mscheiring@brynmawr.edu',
    'Mfon-Ido Akpan': 'makpan@brynmawr.edu',
    'Michaela Olson': 'msolson@brynmawr.edu',
    'Mimi Gordor': 'mgordor@brynmawr.edu',
    'Miriam Ahmed': 'mhahmed@brynmawr.edu',
    ...
    'Swetha Narasimhan': 'snarasimha@brynmawr.edu',
    'Silvie Imeninema': 'simeninema@brynmawr.edu',
    'Taryn Traughber': 'ttraughber@brynmawr.edu',
    'Taylor Milne': 'tmilne@brynmawr.edu',
...
ROOMS = {
    ...
    'Angela Mastrianni': 'Rhoads South 311',
    'Angela Motte': 'Rock 244',
    ...
    'Caitlyn Hasenfratz': 'Rhoads South 101',
	'Carol Bowe': 'Pem West 324',
    'Caroline Randive': 'Rhoads South 302',
    'Callie Lopshire-Bratt': 'Pem East 108',
    'Catherine Woodrow': 'Rhoads South 201',
    'Celeste Ledesma': 'Denbigh 314',
    'Chanel Williams': 'Rock 309',
    'Christina Ulowetz': 'Brecon 105',
    'Chutong Zhu': 'Brecon 306',
    'Claire Craig': 'Brecon 209',
    'Dionne Agawu': 'Rock 124',
    'Ellen Cohn': 'Merion 405',
    'Emily Drummond': 'Pem East 105',
	'Erica Rice': 'Pem West 206',
    'Faatimah Jafiq': 'Erdman 322',
    'Faith Daniel': 'Rock 111',
    'Fiona Gambanga': 'Rhoads South 118',
    'Gabrielle Smith': 'Rock 240',
    ...
    'Maira Karan': 'Rock 229',
    'Makeda Warde': 'Merion 113',
    'Marcia Manzone': 'Brecon 409',
    'Maria McGurrin': 'Rock 109',
    'Margaret Sumner-Moore': 'Pem East 103',
    'Maritza Vazquez-Trejo': 'Denbigh 211',
    'Maya Berrol-Young': 'Pem West 217',
    'Meera Jayaraman': 'Rock 226',
    'Meredith Scheiring': 'Rock 106',
    'Mfon-Ido Akpan': 'Rhoads South 115',
    'Michaela Olson': 'Rock 119',
    ...
    'Swetha Narasimhan': 'Rock 218',
    'Silvie Imeninema': 'Rhoads South 107',
    'Taryn Traughber': 'Erdman 114',
    'Taylor Milne': 'Rock 120',
